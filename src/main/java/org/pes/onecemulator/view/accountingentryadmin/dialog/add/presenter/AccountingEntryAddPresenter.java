...
@SpringComponent
@ViewScope
public class AccountingEntryAddPresenter implements IAccountingEntryAddPresenter {

    private IAccountingEntryAddDialog view;
    ...
    @Autowired
    public AccountingEntryAddPresenter(AccountingEntryService accountingEntryService, ExpenseRequestService expenseRequestService) {
        this.accountingEntryService = accountingEntryService;
        this.expenseRequestService = expenseRequestService;
    }

    @Override
    public void attachView(IAccountingEntryAddDialog view) {
        this.view = view;
    }
