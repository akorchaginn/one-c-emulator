...
import org.pes.onecemulator.view.accountingentryadmin.dialog.add.presenter.IAccountingEntryAddDialog;
import org.pes.onecemulator.view.accountingentryadmin.dialog.add.presenter.IAccountingEntryAddPresenter;
...
public class AccountingEntryAddDialog extends FormDialog implements View, IAccountingEntryAddDialog {
    ...
    private final IAccountingEntryAddPresenter presenter;

    @Autowired
    public AccountingEntryAddDialog(IAccountingEntryAddPresenter presenter) {
