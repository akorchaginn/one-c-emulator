package org.pes.onecemulator.view.expenserequestadmin.dialog.delete.view;

import com.vaadin.navigator.View;
import com.vaadin.navigator.ViewChangeListener.ViewChangeEvent;
import com.vaadin.spring.annotation.SpringView;
import com.vaadin.ui.UI;
import org.pes.onecemulator.view.expenserequestadmin.dialog.delete.presenter.IDeleteExpenseRequestConfirmDialog;
import org.pes.onecemulator.view.expenserequestadmin.dialog.delete.presenter.IDeleteExpenseRequestConfirmPresenter;
...
public class DeleteExpenseRequestConfirmDialog  extends ConfirmDialog implements View, IDeleteExpenseRequestConfirmDialog{
    ...
    private final IDeleteExpenseRequestConfirmPresenter presenter;

    @Autowired
    public DeleteExpenseRequestConfirmDialog(IDeleteExpenseRequestConfirmPresenter presenter) {
