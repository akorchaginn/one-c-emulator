...
import org.pes.onecemulator.view.payeradmin.dialog.edit.presenter.IPayerEditDialog;
import org.pes.onecemulator.view.payeradmin.dialog.edit.presenter.IPayerEditPresenter;
...
public class PayerEditDialog extends FormDialog implements View, IPayerEditDialog {
    ...
    private final IPayerEditPresenter presenter;

    @Autowired
    public PayerEditDialog(IPayerEditPresenter presenter) {
